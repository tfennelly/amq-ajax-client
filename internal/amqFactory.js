...
// See https://github.com/apache/activemq/tree/master/activemq-web-demo/src/main/webapp/js/amq.js

exports.newAmq = function(adapter) {    
    ...
    var sendPoll = function() {
        if (!continuePolling) {
            if (logging) adapter.log('Polling stopped.');
            return;
        }
